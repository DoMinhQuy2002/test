...
$current_url = base64_encode("http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
    ...
    $results = $mysqli->query("SELECT * FROM khachsan ORDER BY id ASC");
    ...
    if ($results) {
...

        {
            ...
            echo '<div class="product-info"><h2>'.$currency.$obj->price.'</h2> <br><button class="add_to_cart">Add To Cart</button></div><br><br><br>';
...

{
    ...
    foreach ($_SESSION["khachsan"] as $cart_itm)
