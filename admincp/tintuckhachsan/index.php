...
<html>
<head>
	<title>Quản Lý Tin tức Khách Sạn</title>
	...
	<div class="container">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h2 class="text-center">Quản Lý Tin tức Khách Sạn</h2>
			</div>
...
foreach ($tintuckhachsanList as $item) {
		...
		echo'<td>'.$item['updated_at'].'</td>
			...
			<td>
				<button class="btn btn-danger" onclick="deleteTintuckhachsan('.$item['id'].')">Xoá</button>
			</td>
		</tr>';
}
?>
	...
	<script type="text/javascript">
		function deleteTintuckhachsan(id) {
